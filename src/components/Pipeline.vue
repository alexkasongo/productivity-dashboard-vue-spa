<template>
  <div class="wrapper">
    <div class="Rtable Rtable--5cols Rtable--collapse">
      ...
      <div class="Rtable-container" v-for="event in gitNew.slice(0, 8)" :key="event.id">
        <div
        ...
        >
          ...
          <div class="Rtable-cell pipeline-cell">
            <div class="Rtable-cell--content title-content">
              <h2 class="Rtable-cell--h2">{{ event.object_attributes.pipeline_id }}</h2>
            </div>
          </div>
          <div class="Rtable-cell commit-cell">
            <div class="commit-cell__events">
              <div class="Rtable-commit--bottom">
                ...
                />
                <h2 class="commit--pad">{{ event.commit.message | truncate(50) }}</h2>
                <div class="Rtable-commit--top">
                  <h5 class="Rtable-commit--branch">
                    <h2>{{ event.object_attributes.ref }}</h2>
                  </h5>
                  <h5 class="commit--number">{{ event.commit.id }}</h5>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="Rtable-cell stages-cell status-container">
            <div v-for="build in event['builds']" :key="build.id" class="status">
              ...
              <div v-if="build.status === 'running'">
                <i class="far fa-check-circle animate-flicker"></i>
              </div>
